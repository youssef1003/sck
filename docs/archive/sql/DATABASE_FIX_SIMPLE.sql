-- ============================================================================
-- Simple Database Fix for SCK Platform - NO ERRORS VERSION
...
-- ============================================================================
-- 1. Fix Users Table - Add missing columns safely
-- ============================================================================
...
-- ============================================================================
-- 2. Create/Update Super Admin with correct password
-- ============================================================================
...
-- ============================================================================
-- 3. Create Password Verification Function (SIMPLE VERSION)
-- ============================================================================

-- Drop old function if exists
DROP FUNCTION IF EXISTS verify_user_password(TEXT, TEXT);

-- Create new simple function that only returns existing columns
...
-- ============================================================================
-- 8. Insert Sample RAG Content (Arabic)
-- ============================================================================

-- Delete old sample data if exists
DELETE FROM rag_documents WHERE source_type = 'company_info';
...
-- ============================================================================
-- 9. Disable RLS (for serverless functions)
-- ============================================================================
...
BEGIN
    ...
    ELSE
        ...
        RAISE NOTICE '   Please check if admin user exists';
    END IF;
END $$;
